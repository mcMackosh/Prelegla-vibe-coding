...
/**
 * Standard Terms of the Common Paper Mutual NDA v1.0 (CC BY 4.0).
 * `{{token}}` marks a cover-page field inlined into the clause text;
 * `**text**` marks bold emphasis. See lib/richText.ts for the parser.
 */
